...
const App = () => {
  ...
  const { refetch: refetchLocations, loading: loadingLocationsData, data: dataLocations } = useGet({
    url: 'https://mostafagadbcknd.food2go.online/customer/address',
    required: true,
  });
    ...
    <PrimeReactProvider>
      {loadingSignUp || loadingProducts || loadingCheckOutDetails || loadingBannerData ||loadingBranchData || loadingLocationsData ? (
        ...
        <div
          ...
          className='relative w-full bg-white flex flex-col justify-between items-center h-screen overflow-y-scroll overflow-x-hidden'>
