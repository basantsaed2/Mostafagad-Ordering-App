...
const CheckOutPage = () => {
       ...
       const { postData: postOrder, loadingPost: loadingOrder, response: responseOrder } = usePost({ url: 'https://mostafagadbcknd.food2go.online/customer/make_order', type: true });
